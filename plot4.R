...
# Top Right Plot
with(powerConsumption, plot(DateTime, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))

# Bottom Right Plot
with(powerConsumption, plot(DateTime, Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power"))
